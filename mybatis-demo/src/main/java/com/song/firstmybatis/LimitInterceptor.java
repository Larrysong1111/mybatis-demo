...
public class LimitInterceptor implements Interceptor {
    ...
    public void setProperties(Properties properties) {
    	...
    	String dialectClass ="com.deppon.dpap.data.dialect.OracleDialect";
    	
    	if(DBSwitch.DB_SWITCH_MYSQL == DBSwitch.getDbSwitch()){
    		dialectClass = "com.deppon.dpap.data.dialect.MySQLDialect";
		}
        try {
